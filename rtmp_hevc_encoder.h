#ifndef SIMPLE_RTMP_RTMP_HEVC_ENCODER_H
#define SIMPLE_RTMP_RTMP_HEVC_ENCODER_H
...
class rtmp_hevc_encoder : public rtmp_encoder
{
   public:
    explicit rtmp_hevc_encoder(std::string id);
    ~rtmp_hevc_encoder() override = default;
