#ifndef SIMPLE_RTMP_H265_DECODER_H
#define SIMPLE_RTMP_H265_DECODER_H
...
{
class rtmp_h265_decoder : public rtmp_decoder
{
   public:
    explicit rtmp_h265_decoder(std::string id);
    ~rtmp_h265_decoder() override;
