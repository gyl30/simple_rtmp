...
namespace RTC
{
class TransportTuple : public std::enable_shared_from_this<TransportTuple>
{
   public:
    enum class Protocol
    {
   ...
   public:
    TransportTuple() = default;
    ~TransportTuple() = default;

   public:
    bool Compare(const TransportTuple* tuple) const
    {
        return localAddress == tuple->localAddress && remoteAddress == tuple->remoteAddress;
    }
...
class IceServer
{
   ...
   public:
    class Listener
    {
       ...
       public:
         ...
         */
        virtual void OnIceServerSendStunPacket(const RTC::IceServer* iceServer, const RTC::StunPacket* packet, RTC::TransportTuple* tuple) = 0;
        virtual void OnIceServerLocalUsernameFragmentAdded(const RTC::IceServer* iceServer, const std::string& usernameFragment) = 0;
        virtual void OnIceServerLocalUsernameFragmentRemoved(const RTC::IceServer* iceServer, const std::string& usernameFragment) = 0;
        virtual void OnIceServerTupleAdded(const RTC::IceServer* iceServer, RTC::TransportTuple* tuple) = 0;
        virtual void OnIceServerTupleRemoved(const RTC::IceServer* iceServer, RTC::TransportTuple* tuple) = 0;
        virtual void OnIceServerSelectedTuple(const RTC::IceServer* iceServer, RTC::TransportTuple* tuple) = 0;
   ...
   private:
    void HandleTuple(RTC::TransportTuple* tuple, bool hasUseCandidate, bool hasNomination, uint32_t nomination);
    /**
